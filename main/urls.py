...
from main.views import show_main, create_products, show_products, show_xml, show_json, show_xml_by_id, show_json_by_id, register, user_login, user_logout, edit_products, delete_products, add_product_entry_ajax, update_product_entry_ajax, user_login_ajax, register_ajax, proxy_image, create_product_flutter, get_my_product_json
app_name = 'main'
...
urlpatterns = [
    ...
    path('my-products-json/', get_my_product_json, name='get_my_product_json'),
]